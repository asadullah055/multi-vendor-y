            ...
            {[1, 2, 3, 4, 5, 6].map((o, i) => (
              <div key={i} className="text-[#d0d2d6]">
                <div className="flex justify-between items-start border-b border-slate-700">
                  ...
                  <div className="py-4 w-[13%]">$50</div>
                  <div className="py-4 w-[18%]">ddd</div>
                  <div className="py-4 w-[18%]">deed</div>
                ...
                >
                  {[1, 2, 3].map((so, i) => (
                    ...
                    >
                      ...
                      <div className="py-4 w-[13%]">$50</div>
                      <div className="py-4 w-[18%]">dg</div>
                      <div className="py-4 w-[18%]">dleter</div>
                    </div>
                  ))}
                </div>
              </div>
